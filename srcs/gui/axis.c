...
/*   Updated: 2025/06/10 21:01:58 by amagno-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_axis_info(t_data *img)
{
	...
	project_axis_vector(x_axis, center, x_end, &img->view);
	project_axis_vector(y_axis, center, y_end, &img->view);
	project_axis_vector(z_axis, center, z_end, &img->view);
