...
/*   Updated: 2025/06/17 17:59:05 by amagno-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	smooth_shift(t_data *data)
{
	...
	{
		data->view.off_y -= data->view.shift_step * log10(data->view.zoom);
	...
	{
		data->view.off_x -= data->view.shift_step * log10(data->view.zoom);
