...
/*   Updated: 2025/06/17 17:48:12 by amagno-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (((point->display[0] + data->view.offset_x)
			> (data->m_width - data->view.zoom))
		&& (point->display[0] + data->view.offset_x)
		< (data->w_width + data->view.zoom)
		&& (point->display[1] + data->view.offset_y)
		> (-data->view.zoom)
		&& (point->display[1] + data->view.offset_y)
